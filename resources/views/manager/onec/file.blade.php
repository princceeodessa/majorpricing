    ...
    <section class="surface-card p-8 sm:p-10">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('admin.onec.catalog.file.download', ['session_key' => $sessionKey, 'filename' => $filename]) }}" class="ghost-button">Скачать XML</a>
                <a href="{{ route('admin.onec.catalog.package.download', ['session_key' => $sessionKey]) }}" class="ghost-button">Скачать пакет</a>
