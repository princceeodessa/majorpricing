...
@section('title', 'ПОТОЛКОВЫЧ — вход в личный кабинет')
@section('meta_description', 'ПОТОЛКОВЫЧ — личный кабинет для клиентов и менеджеров. Вход в систему, заявка на регистрацию и доступ к каталогу после подтверждения менеджером.')
